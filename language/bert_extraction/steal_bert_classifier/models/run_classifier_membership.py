...
# Lint as: python3
"""Train and test a membership classifier on top of a frozen BERT MNLI model."""
...
tf.flags.DEFINE_string("membership_features_str", "last_plus_logits",
                       "Features to use for the membership classification.")
...
class DataProcessor:
  ...
  def get_original_num_labels(self):
    raise NotImplementedError()
...
def create_model(bert_config, is_training, input_ids, input_mask, segment_ids,
  ...
  membership_bias = tf.get_variable(
      "cls/membership/bias", [2], initializer=tf.zeros_initializer())
...
def model_fn_builder(bert_config, num_labels, init_checkpoint, learning_rate,
                     use_tpu, use_one_hot_embeddings, membership_features_str):
  ...
  def model_fn(features, labels, mode, params):  # pylint: disable=unused-argument
    ...
    membership_logits, membership_vars = create_model(bert_config, is_training,
                                                      ...
                                                      segment_ids, num_labels,
                                                      use_one_hot_embeddings,
                                                      membership_features_str)
...
def main(_):
  ...
  model_fn = model_fn_builder(
      ...
      num_labels=processor.get_original_num_labels(),
  ...
  if FLAGS.do_train:
    train_file = os.path.join(FLAGS.output_dir,
                              FLAGS.exp_name + "train.tf_record")
