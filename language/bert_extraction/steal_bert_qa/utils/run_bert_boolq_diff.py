...
"""Compare the agreement between two BERT-based BoolQ models on a dataset."""
...
flags.DEFINE_string("init_checkpoint1", None,
                    "First checkpoint to use during comparison.")

flags.DEFINE_string("init_checkpoint2", None,
                    "Second checkpoint to use during comparison.")
...
def _create_examples(filename, set_type):
  ...
  with tf.gfile.Open(filename) as f:
    for i, line in enumerate(f):
      ...
      probs = data["soft_answer"] if "soft_answer" in data else [1.0, 0]
      examples.append(
          BoolQExample(
              guid=guid,
              text_a=data["passage"],
