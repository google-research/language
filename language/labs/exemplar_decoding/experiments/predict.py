...
flags.DEFINE_float("sigma_norm", 1.0,
...
flags.DEFINE_bool("predict_mode", True,
                  "Use this to run predictions on test set.")

flags.DEFINE_bool("sample_neighbor", False, "Self attention.")

flags.DEFINE_string("model_dir", None, "String for model directory.")
